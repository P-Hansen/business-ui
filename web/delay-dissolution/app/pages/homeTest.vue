...
const expandableSections = ref([
  {
    title: 'This business is in the process of being dissolved',
    details: 'This business will be struck from the Business Registry as soon as <b>September 31, 2024</b> due to overdue annual reports. ' +
      ...
      <div v-for="(section, i) in expandableSections" :key="i" class="pt-4">
        <div class="flex justify-between items-center">
          <div class="flex items-center gap-2">
            <img :src="`/icons/${section.icon}`" alt="Warning" class="icon" />
            <h3>{{ section.title }}</h3>
          </div>
        ...
        <div v-if="section.open" class="mt-2 text-gray-700 section-details">
          <div v-if="section.open" class="mt-2 text-gray-700" v-html="section.details"></div>
...
.section-container > div:not(:last-child) {
